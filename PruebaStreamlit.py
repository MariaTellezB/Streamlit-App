...
with daViz:
    ...
    filtro =st.radio('Elige una opcion', ['Ambos','Hombres', 'Mujeres'])
...
#st.text('Tan razonable como representar una prisiòn de cierto género por otra diferente es representar algo que existe realmente por algo que no existe.')
#st.text('-DANIEL DE FOE')
